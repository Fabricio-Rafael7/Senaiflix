...
<h1 style="color:white;">Listagem de ADMs</h1>
<table class="table table-striped">
    ...
    ?>
        <tr>
            ...
            <td style="color:white;"><?php echo htmlspecialchars($linha['usuario']); ?></td>
            <td>
                <a href='index.php?pagina=usuario_edita&id=<?php echo htmlspecialchars($linha['id']); ?>'>
            ...
            <td>
                <a href='index.php?pagina=usuario_remover&id=<?php echo htmlspecialchars($linha['id']); ?>'>
